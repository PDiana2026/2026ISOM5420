...
def apply_css() -> None:
    """Inject all custom CSS for the Ocean Adventure theme."""
    st.markdown(
        """
        <style>
        /* ── Google Fonts ─────────────────────────────────────────── */
        ...
        /* ── Diagonal-stripe ocean background ────────────────────── */
        .main > div {
            background:
        ...
        /* ── Floating sea-creature decorations ───────────────────── */
        .hero-creatures {
            display: flex;
        ...
        .card-caption { background: #fffde7; }           /* warm yellow  */
        .card-story   { background: #eef2ff; }           /* lavender-blue */
        .card-audio   { background: #e8f5e9; }           /* seafoam green */
